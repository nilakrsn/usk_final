      ...
      <SafeAreaView className="bg-white w-full h-full">
        ...
        >
          ...
          <View className="py-0 flex p-3 justify-between ">
            <View className="bg-cyan-500 rounded-lg flex flex-col items-center">
              <View className=" flex flex-row py-2">
                <View className=" flex-1  flex-row items-center  justify-center">
                  <View>
                    <Text className="font-bold text-lg text-white">Order</Text>
                    <Text className="text-base text-white text-center">
                      {dataAdmin.wallet_count}
                    </Text>
                  </View>
                </View>
                <View className="flex-1 flex-row items-center justify-center ">
                  <View>
                    <Text className="font-bold text-lg text-white">User</Text>
                    <Text className="text-base text-white text-center">
                      {dataAdmin?.users?.length}
                    </Text>
                  </View>
                </View>
                <View className="flex-1 flex-row items-center justify-center ">
